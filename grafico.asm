...
INSERE_RESULTADO_LCD:
   ...
   INC BX
REPETE_INSERE_RESULTADO:
   CMP CL, 72
   JG SAI_INSERE_RESULTADO_LCD
   MOV CONTADOR_POSICAO_COLUNA_INICIO_GRAFICO, CL
   MOV CONTADOR_POSICAO_LINHA_FIM_GRAFICO, 50
   PUSH AX
   MOV AL, [BX]
   SUB AL, 48
   SUB CONTADOR_POSICAO_LINHA_FIM_GRAFICO, AL
   POP AX
   CALL INSERE_COLUNA_LCD
   INC BX
   ADD CL, 8
   JMP REPETE_INSERE_RESULTADO
SAI_INSERE_RESULTADO_LCD:
   POP CX
   POPF
   RET
