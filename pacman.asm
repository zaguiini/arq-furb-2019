...
;-----------------------------------------------------
	...
	LOOP_START:
		...
		CALL INSERE_PACMANZERA
		;CALL INSERE_BARREIRAS
LOOP_DO_JOGO:
...
INSERE_PACMANZERA:
   ...
   PUSH AX
   PUSH BX
REPETE_INSERE_PACMANZERA:
   CALL RANDOM
   CMP AL, 112
   JG REPETE_INSERE_PACMANZERA
   ADD BL, AL
   MOV MATRIZ_PACMANZERA[BX], 129
SAI_INSERE_PACMANZERA:
   POP BX
   POP AX
   POPF
   RET
...
ENABLE_PULSE:
   ...
   RET
	...
	;129 = PACMANZERA
	;128 = BARREIRAZONA
	MATRIZ_PACMANZERA  DB 32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32
