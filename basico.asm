...
CODE  SEGMENT
   ...
   inicio:
	 ...
	 CALL PREENCHE_LETRAS
	 
	 CALL PULA_LINHA
	 MOV BX, OFFSET MENSAGEM_PALAVRA_PARCIAL
	 CALL MANDA_MENSAGEM
...
PREENCHE_LETRAS:
   ...
   MOV CL, 0
   MOV BX, OFFSET PALAVRA_A_SER_DECIFRADA
   INC BX ; [BX] = LETRA N DA PALAVRA
   MOV SI, OFFSET LETRA_ATUAL
   INC SI ; [SI] = LETRA ATUAL
...
DATA SEGMENT
   ...
   MENSAGEM_PALAVRA_PARCIAL DB ?, "PALAVRA PARCIAL E: ", 0
   MENSAGEM_FIM DB ?, "PARABENS VOCE GANHOU", 0

   PALAVRA_A_SER_DECIFRADA DB ?, TAM_STRING + 1 DUP(?)
   LETRA_ATUAL DB 1, ?, 0
   PALAVRA_PARCIAL DB ?, TAM_STRING + 1 DUP("_"), 0
